...
export default async function DocPage({ params }: DocPageProps) {
  ...
  return (
    <main className="relative max-w-full overflow-hidden py-6  lg:gap-10 lg:py-10 xl:grid xl:grid-cols-[1fr_300px] xl:overflow-visible">
      {/* <div
        id="scroll-shadow"
        className="pointer-events-none fixed left-[275px] top-7 z-10 h-[200px] w-[100%] select-none bg-[linear-gradient(to_top,transparent,#000000)] blur-sm will-change-transform [mask-image:linear-gradient(to_bottom,transparent,white_20%,white_80%,transparent)] xl:w-[53%]"
      /> */}
